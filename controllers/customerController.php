<?php
	...
	function insertUser($c_id, $name, $dob, $age, $mobile, $address,  $status, $gender, $email, $image)
	{
		
		$query="INSERT INTO customer VALUES('$c_id','$name','$dob','$age','$mobile','$address', '$status', '$gender','$email', '$image')";
		execute($query);
